	...
	<div align="center">
		<form id="reviewForm" >
			<table class="normal" width="60%">
				<tr>
					<td><h2>You already wrote review for this book</h2></td>
					<td>&nbsp;</td>
				...
				<tr>
					...
					<td>
						...
						<br/>
						<textarea name="comment" cols="70" rows="10" readonly="readonly"  placeholder="Write your review details..." ></textarea>
					</td>
				</tr>
